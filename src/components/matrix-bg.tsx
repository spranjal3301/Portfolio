...
const MatrixRain: React.FC<MatrixRainProps> = ({
  ...
  }, [intensity, speed,width, height]);

  return(
    <div ref={containerRef} className={cn("relative size-full",className)}>
      <canvas ref={canvasRef} className={cn("absolute inset-0 z-[-1] opacity-25 w-full h-full")} />
    {/* <div className="text-green-500 text-xl font-bold shadow-lg [text-shadow:0_0_10px_rgba(0,255,0,1)]"> */}
    <div>
      {children}
    </div>
  </div> 
